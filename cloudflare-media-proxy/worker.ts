...
const MEGAPLAY_REFERER_DOMAINS =
  /(?:shiora|mikora)\.(?:top|site|club|net)|lostproject\.club|(?:megap|vidtub)\.(?:shiora\.(?:top|site)|akirax\.buzz)|megap\.(?:mikora|norami|akirax)\.(?:top|buzz)|cdn\.mewstream\.|livedns\.|(?:^|\.)imgnex\.top$|(?:^|\.)nexabloom\.top$/i;
